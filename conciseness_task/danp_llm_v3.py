...
def parse_args():
    ...
    p.add_argument("--output_dir",    default="./out_danp_v2")
...
# ===========================================================================
# DANP Hook — v2: CUMULATIVE noisy forward pass matching Algorithm 1
# ===========================================================================
class DANPHook:
    """
...
# ===========================================================================
def decorrelation_delta_r(x_star, R, alpha, dec_clip=0.1):
    if alpha <= 0:
        return None
...
def danp_grad_single(
    ...
    n_population, max_scale, max_update, alpha,
    ...
    for pop_i in range(n_population):
        ...
        if verbose and pop_i == 0:
            print(f"\n[DANP v2 grad] L_clean={L_clean:.4f} L_noisy={L_noisy:.4f} "
...
def danp_batch_step(model, tokenizer, batch, device, hook,
    ...
    for i, example in enumerate(batch):
        ...
        updates, dec_updates, L_clean, dL = danp_grad_single(
            ...
            n_population=n_population, max_scale=max_scale, max_update=max_update,
    ...
    for epoch in range(args.epochs):
        ...
        for step, start in enumerate(pbar):
            ...
            L, dL = danp_batch_step(
                ...
                max_scale=args.max_scale, max_update=args.max_update,
